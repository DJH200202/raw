...
def parse_args():
    ...
    parser.add_argument("--results_file", type=str, default="results/2wiki_eval/2wiki_validation_results.jsonl", help="Path to the results file")
    parser.add_argument("--output_file", type=str, default="results/2wiki_eval/2wiki_eval_results.json", help="Path to save evaluation results")
...
def main():
    ...
    with open(args.output_file, 'w') as f:
        json.dump({"2wiki": scores}, f, ensure_ascii=False, indent=4)
    
    # Display results to console
    print(f"dataset 2wiki scores {scores}")
