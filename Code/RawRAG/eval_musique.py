...
def parse_args():
    ...
    parser.add_argument(
        "--results_file",
        type=str,
        default="results/musique_eval/musique_validation_results.jsonl",
        help="Path to the results file",
    )
    parser.add_argument(
        "--output_file",
        type=str,
        default="results/musique_eval/musique_eval_results.json",
...
def main():
    ...
    with open(args.output_file, "w") as f:
        json.dump({"musique": scores}, f, ensure_ascii=False, indent=4)

    # Display results to console
    print(f"dataset musique scores {scores}")
